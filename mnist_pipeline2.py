...
def model_train(model_info_path: Output[Artifact]):
    ...
    return dsl.ContainerSpec(image='jaganacr05052025.azurecr.io/kubeflow/mnist-trainer:latest', 
...
def model_evaluate(model_info_path: Input[Artifact]):
    return dsl.ContainerSpec(
        image='jaganacr05052025.azurecr.io/kubeflow/mnist-evaluator:latest',
        command=['/bin/sh'],
        args=[
            '-c',
